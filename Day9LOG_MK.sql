...
MariaDB [CSD2204S2018]> DESC COUNTRIES;
+--------------+---------------+------+-----+---------+-------+
...
MariaDB [CSD2204S2018]> DESC JOB_HISTORY;
+---------------+--------------+------+-----+---------+-------+
| Field         | Type         | Null | Key | Default | Extra |
+---------------+--------------+------+-----+---------+-------+
...
MariaDB [CSD2204S2018]> DESC LOCATIONS;
+----------------+--------------+------+-----+---------+-------+
| Field          | Type         | Null | Key | Default | Extra |
+----------------+--------------+------+-----+---------+-------+
...
MariaDB [CSD2204S2018]> DESC REGIONS;
+-------------+--------------+------+-----+---------+-------+
| Field       | Type         | Null | Key | Default | Extra |
+-------------+--------------+------+-----+---------+-------+
...
MariaDB [CSD2204S2018]> SELECTB*NFROM EMPLOYEES;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'SELECTB*NFROM EMPLOYEES' at line 1
...
MariaDB [CSD2204S2018]> SELECT  salary FROM EMPLOYEES WHERE LAST_NAME LIKE 'Bull';
+---------+
| salary  |
+---------+
| 4100.00 |
...
MariaDB [CSD2204S2018]> SELECT first_name, last_name, salary FROM EMPLOYEES WHERE salary > 4100;
+-------------+------------+----------+
...
MariaDB [CSD2204S2018]> SELECT first_name, last_name, salary FROM EMPLOYEES WHERE salary > 
...
MariaDB [CSD2204S2018]> SELECT first_name, last_name, department_id FROM employees WHERE department_id = 
...
MariaDB [CSD2204S2018]> SELECT department_id FROM departments WHERE location_id IN (SELECT location_id, country_id FROM locations WHERE country_id = 'US');
...
MariaDB [CSD2204S2018]> SELECT first_name FROM employees WHERE employee_id IN (SELECT manager_id from employees);
+------------+
| first_name |
+------------+
| Steven     |
...
MariaDB [CSD2204S2018]> SELECT DISTINCT(manager_id) WHERE manager_id != 0;
...
MariaDB [CSD2204S2018]> SELECT first_name, last_name FROM employees WHERE IN (SELECT DISTINCT(manager_id) FROM employees WHERE manager_id != 0);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN (SELECT DISTINCT(manager_id) FROM employees WHERE manager_id != 0)' at line 1
MariaDB [CSD2204S2018]> SELECT first_name, last_name FROM employees WHERE IN (SELECT DISTINCT(manager_id) FROM employees WHERE manager_id != 0));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN (SELECT DISTINCT(manager_id) FROM employees WHERE manager_id != 0))' at line 1
MariaDB [CSD2204S2018]> SELECT first_name, last_name FROM employees WHERE IN (SELECT DISTINCT(manager_id) FROM employees WHERE manager_id != 0);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN (SELECT DISTINCT(manager_id) FROM employees WHERE manager_id != 0)' at line 1
...
MariaDB [CSD2204S2018]> SELECT first_name, last_name, salary FROM employees WHERE salary > avg(salary);
...
MariaDB [CSD2204S2018]> SELECT min_salry FROM jobs WHERE job_id IN (SELECT job_id FROM employees);
ERROR 1054 (42S22): Unknown column 'min_salry' in 'field list'
...
MariaDB [CSD2204S2018]> SELECT first_name FROM employees WHERE salary IN (SELECT min_salary FROM jobs WHERE job_id IN (SELECT job_id FROM employees));
+-------------+
| first_name  |
+-------------+
| Alexander   |
...
MariaDB [CSD2204S2018]> SELECT first_name FROM employees WHERE salary = (SELECT min_salary FROM jobs WHERE job_id IN (SELECT job_id FROM employees));
ERROR 1242 (21000): Subquery returns more than 1 row
MariaDB [CSD2204S2018]> SELECT first_name FROM employees WHERE salary LIKe  (SELECT min_salary FROM jobs WHERE job_id IN (SELECT job_id FROM employees));
ERROR 1242 (21000): Subquery returns more than 1 row
MariaDB [CSD2204S2018]> SELECT first_name FROM employees WHERE salary =  (SELECT min_salary FROM jobs WHERE job_id = (SELECT job_id FROM employees));
ERROR 1242 (21000): Subquery returns more than 1 row
...
MariaDB [CSD2204S2018]> SELECT avg(salary) FROM empoyees;
ERROR 1146 (42S02): Table 'csd2204s2018.empoyees' doesn't exist
MariaDB [CSD2204S2018]> SELECT avg(salary) FROM employees;
+-------------+
| avg(salary) |
+-------------+
...
MariaDB [CSD2204S2018]> SELECT first_name, last_name,salary, department_id FROM employees WHERE salary > (SELECT department_id FROM departments WHERE department_name LIKE 'IT%') AND department_id IN(SELECT department_id FROM departments WHERE department_name LIKE 'IT%');
ERROR 1242 (21000): Subquery returns more than 1 row
